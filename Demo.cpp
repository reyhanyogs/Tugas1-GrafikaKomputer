...
void Demo::DrawColoredCube()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0 + position1, 6, 0));

	model = glm::rotate(model, angle, glm::vec3(0, 1, 0));

	model = glm::scale(model, glm::vec3(10, 1, 1));
...
void Demo::DrawColoredCube2()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0 + position1, 5, 0));
...
void Demo::DrawColoredCube3()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(0 + position1, 3.5, 0));

	model = glm::scale(model, glm::vec3(5, 2, 1));
...
void Demo::DrawColoredCube4()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(5 + position1, 3.5, 0));
...
void Demo::DrawColoredCube5()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(10 + position1, 3.5, 0));
